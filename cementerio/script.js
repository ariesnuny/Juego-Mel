...
salta.src = "../IMG/Piso mel cementerio.png";
var fondo = document.createElement("img");
fondo.src = "../IMG/Fondo mel cementerio.png";
var elementos = document.createElement("img");
elementos.src = "../IMG/Elementos fondo mel cementerio.png";
var final = document.createElement("img");
final.src = "../IMG/Ouija board mel.png";
...
class MedioFondo {
    ...
    draw() {
        c.drawImage(this.image, this.position.x, this.position.y, 9999, 400)
    }
}
...
function init() {
    ...
    medioFondos = [ new MedioFondo({x:0, y:85, image: elementos})]
    tiburon = new Tiburon({x: 8400, y: 350, image: final})
